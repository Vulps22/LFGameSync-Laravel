...
<div class="flex flex-col mx-5 mt-5">
	...
	<div class="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 pb-20">
		<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
			<div class="flex flex-col">
				<div class="mt-5 flex flex-col items-center">
					...
					<div>
						<h1 class="font-medium">{{ Auth()->user()->discordUser()['username'] }}</h1>
					</div>
				</div>

				<div class="mx-5 mb-5 flex flex-col">
					<button class="w-full bg-blue-500 text-white px-4 py-2 rounded mt-4">Sync Servers</button>
					<button class="btn border border-red-700 text-red-700 px-4 py-4 rounded mt-4">Logout</button>
				</div>
			</div>
		</div>
	</div>

	<div class="mt-2 ml-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 pb-20">
		<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
			<div class="flex flex-col">
				<div class="mt-5 flex flex-col items-center">
					<div class="flex-shrink-0">
	...
	<div class="grow border rounded p-4 my-4">
